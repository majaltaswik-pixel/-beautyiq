(function () {
  ...
  style.textContent = '#bq-wrap{all:initial;display:flex;gap:24px;align-items:flex-start;margin:24px 0;}#bq-wrap>*{flex:1;min-width:0;}#bq-wrap .bq-pw{flex:0 0 340px;max-width:340px;}.bq-p{background:#f9fafb;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Inter,sans-serif;}.bq-p *{box-sizing:border-box;}.bq-h{padding:16px 18px;background:linear-gradient(135deg,#7c3aed,#9333ea);display:flex;align-items:center;gap:12px;}.bq-av{width:36px;height:36px;background:rgba(255,255,255,0.2);border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;}.bq-hi{flex:1;}.bq-ht{font-size:0.9rem;font-weight:700;color:#fff;}.bq-hs{font-size:0.7rem;color:rgba(255,255,255,0.8);display:flex;align-items:center;gap:5px;margin-top:1px;}.bq-hd{width:6px;height:6px;background:#4ade80;border-radius:50%;}.bq-b{flex:1;padding:18px;display:flex;flex-direction:column;gap:12px;min-height:200px;max-height:380px;overflow-y:auto;}.bq-m{background:#fff;padding:14px 16px;border-radius:14px;border-bottom-left-radius:4px;font-size:0.85rem;color:#374151;line-height:1.6;box-shadow:0 1px 3px rgba(0,0,0,.06);align-self:flex-start;max-width:90%;}.bq-mu{align-self:flex-end;background:#7c3aed;color:#fff;border-bottom-left-radius:14px;border-bottom-right-radius:4px;}.bq-cr{display:flex;gap:10px;align-self:stretch;}.bq-cd{flex:1;background:#fff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;}.bq-cd img{width:100%;height:120px;object-fit:cover;display:block;background:#f3f4f6;}.bq-ci{width:100%;height:120px;background:#f3f4f6;display:flex;align-items:center;justify-content:center;}.bq-cii{padding:10px 12px 12px;}.bq-ct{font-weight:600;font-size:0.82rem;color:#111827;line-height:1.3;}.bq-cp{font-size:0.85rem;font-weight:700;color:#059669;margin-top:3px;}.bq-cm{font-size:0.7rem;color:#7c3aed;font-weight:600;margin-top:2px;}.bq-ch{display:flex;flex-wrap:wrap;gap:8px;margin-bottom:4px;}.bq-c{padding:7px 14px;border:1px solid #c4b5fd;border-radius:100px;font-size:0.75rem;color:#5b21b6;background:#fff;font-weight:500;cursor:pointer;}.bq-c:hover{background:#ede9fe;border-color:#7c3aed;}.bq-in{display:flex;align-items:center;gap:10px;padding:16px 18px;border-top:1px solid #e5e7eb;}.bq-ip{flex:1;padding:10px 16px;border:1px solid #d1d5db;border-radius:10px;font-size:0.82rem;outline:none;background:#fff;color:#374151;}.bq-ip:focus{border-color:#7c3aed;}.bq-sb{width:40px;height:40px;background:#7c3aed;border:none;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;cursor:pointer;}.bq-sb:disabled{opacity:.4;}.bq-sb svg{width:18px;height:18px;stroke:#fff;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;}.bq-sk{padding:5px 12px;background:rgba(255,255,255,0.15);border:1px solid rgba(255,255,255,0.25);color:#fff;border-radius:6px;font-size:0.72rem;cursor:pointer;font-weight:600;white-space:nowrap;}.bq-sk:hover{background:rgba(255,255,255,0.25);}.bq-prof{padding:14px 18px;background:#faf5ff;border-bottom:1px solid #e5e7eb;display:none;}.bq-prof.open{display:block;}.bq-pl{font-size:0.68rem;font-weight:700;color:#7c3aed;text-transform:uppercase;letter-spacing:.4px;margin-bottom:8px;}.bq-sc{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:12px;}.bq-sc button{padding:5px 12px;border:1px solid #d1d5db;border-radius:14px;font-size:0.72rem;cursor:pointer;background:#fff;color:#4b5563;}.bq-sc button.a{border-color:#7c3aed;background:#ede9fe;color:#7c3aed;font-weight:600;}.bq-sc button:hover{border-color:#a78bfa;}.bq-load{display:flex;align-items:center;gap:8px;padding:8px 0;}.bq-dot{width:6px;height:6px;background:#7c3aed;border-radius:50%;animation:bqP 1.5s infinite;}.bq-lt{font-size:0.75rem;color:#9ca3af;}@keyframes bqP{0%,100%{opacity:1}50%{opacity:.4}}@media(max-width:768px){#bq-wrap{flex-direction:column;}#bq-wrap .bq-pw{flex:1;max-width:100%;}}';
  ...
  wrap.innerHTML =
    ...
    '<div class="bq-h"><div class="bq-av"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div><div class="bq-hi"><div class="bq-ht">Smart Beauty Advisor</div><div class="bq-hs"><span class="bq-hd"></span>Online — typically replies instantly</div></div><button class="bq-sk" id="bq-sk">My Skin</button></div>' +
  ...
  function addProdRow(prods) {
    ...
    prods.slice(0, 2).forEach(function (p) {
      ...
      cd.className = 'bq-cd';
      cd.innerHTML = (img ? '<img src="' + img + '" alt="" loading="lazy">' : '<div class="bq-ci"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div>') +
        '<div class="bq-cii"><div class="bq-ct">' + t + '</div>' + (priceStr ? '<div class="bq-cp">' + priceStr + '</div>' : '') + (mt > 0 ? '<div class="bq-cm">' + mt + '% match for your skin</div>' : '') + '</div>';
      row.appendChild(cd);
    });
    bd.appendChild(row);
    bd.scrollTop = bd.scrollHeight;
  ...
  function send() {
    ...
    ld.innerHTML = '<div class="bq-dot"></div><div class="bq-dot" style="animation-delay:.2s"></div><div class="bq-dot" style="animation-delay:.4s"></div><span class="bq-lt">Finding your perfect skincare match...</span>';
    bd.appendChild(ld);
    bd.scrollTop = bd.scrollHeight;
    ...
    .then(function (data) {
      ...
      if (routine && routine.length) {
        var h = '<div style="font-weight:700;font-size:0.8rem;color:#7c3aed;margin-bottom:6px;">Your Routine</div>';
        routine.forEach(function (s, i) { h += '<div style="display:flex;align-items:center;gap:6px;padding:3px 0;font-size:0.78rem;"><span style="width:18px;height:18px;background:#7c3aed;color:#fff;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:0.6rem;font-weight:700;">' + (i + 1) + '</span><span>' + s.name + '</span></div>'; });
        addMsg(h);
      }
      addChips([
